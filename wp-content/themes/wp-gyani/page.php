    ...
    <main id="primary" class="site-main">
        ...
        <section class="relative bg-gradient-to-br from-teal-light via-white to-teal-subtle dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 border-b border-bordercolor dark:border-gray-800 pt-8 pb-10 md:pt-10 md:pb-12 overflow-hidden">
            ...
            <div class="max-w-[1280px] mx-auto px-4 md:px-8 relative z-10">
                ...
                <?php if (has_excerpt()): ?>
                    <p class="font-inter text-textmuted dark:text-gray-400 text-base md:text-lg mt-4 max-w-3xl leading-relaxed"><?php echo esc_html(get_the_excerpt()); ?></p>
                <?php endif; ?>

                <div class="text-xs text-textmuted dark:text-gray-500 mt-5">Last updated <?php echo get_the_modified_date(); ?></div>
            </div>
        </section>
        ...
        <?php if (has_post_thumbnail()): ?>
            <div class="max-w-[1280px] mx-auto px-4 md:px-8">
                <div class="relative aspect-[16/6] rounded-2xl overflow-hidden bg-teal-light dark:bg-gray-800 border border-bordercolor dark:border-gray-700 mt-8">
            ...
            <div class="max-w-[1280px] mx-auto px-4 md:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    ...
                    <div class="lg:col-span-8">
                        <article <?php post_class('bg-white dark:bg-transparent'); ?>>
                            <div class="prose max-w-none font-inter text-base md:text-[17px] leading-relaxed text-charcoal dark:text-gray-300
                                        prose-headings:font-manrope prose-headings:font-extrabold prose-headings:text-charcoal prose-headings:dark:text-white
                                        prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4
                                        prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3
                                        prose-a:text-teal prose-a:font-semibold hover:prose-a:text-teal-dark dark:hover:prose-a:text-teal-light
                                        ...
                                        prose-blockquote:border-l-teal prose-blockquote:bg-teal-light/50 prose-blockquote:dark:bg-teal-900/30 prose-blockquote:not-italic prose-blockquote:py-1 prose-blockquote:rounded-r-lg
                                        ...
                                        prose-table:overflow-hidden prose-th:bg-offwhite prose-th:dark:bg-gray-800"
                                 id="page-content">
                                <?php the_content(); ?>
                            </div>
                        </article>
                        ...
                        if ($children):
                        ?>
                            <div class="mt-10 pt-8 border-t border-bordercolor dark:border-gray-700">
                                <h2 class="font-manrope font-extrabold text-lg text-charcoal dark:text-white mb-4">On This Page</h2>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <?php foreach ($children as $child): ?>
                                        <a href="<?php echo esc_url(get_permalink($child)); ?>" class="group p-4 rounded-xl border border-bordercolor dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-teal dark:hover:border-teal hover:shadow-card-hover transition-all flex items-center justify-between">
                                            <span class="font-manrope font-bold text-sm text-charcoal dark:text-white group-hover:text-teal dark:group-hover:text-teal transition-colors"><?php echo esc_html(get_the_title($child)); ?></span>
                                            <svg class="w-4 h-4 text-textmuted dark:text-gray-400 group-hover:text-teal dark:group-hover:text-teal group-hover:translate-x-0.5 transition-all flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                    ...
                    <aside class="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
                        ...
                        <div id="page-toc-card" class="p-6 rounded-2xl bg-white dark:bg-gray-800 border border-bordercolor dark:border-gray-700 shadow-soft hidden">
                            ...
                            <ul id="page-toc-list" class="space-y-2.5 text-sm font-medium text-textmuted dark:text-gray-400"></ul>
                        </div>
                        ...
                        <!-- NEWSLETTER CTA -->
                        <div class="p-6 rounded-2xl bg-offwhite dark:bg-gray-800 border border-bordercolor dark:border-gray-700">
                            <h3 class="font-manrope font-extrabold text-base text-charcoal dark:text-white mb-2">Weekly WordPress Tips</h3>
                            <p class="text-textmuted dark:text-gray-400 text-sm leading-relaxed mb-4"><?php echo esc_html(get_theme_mod('newsletter_description', 'Actionable tutorials, speed tweaks and resources delivered straight to your inbox.')); ?></p>
                            <form onsubmit="handleSubscribe(event)" class="space-y-2">
                                <input type="email" id="newsletter-email" required placeholder="you@example.com" class="w-full px-4 py-2.5 rounded-xl bg-white dark:bg-gray-700 border border-bordercolor dark:border-gray-600 text-charcoal dark:text-white placeholder-textmuted dark:placeholder-gray-400 text-sm focus:outline-none focus:border-teal">
