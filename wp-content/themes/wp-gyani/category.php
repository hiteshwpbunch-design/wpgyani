...
<main id="primary" class="site-main">
    ...
    <section class="bg-offwhite border-b border-bordercolor py-10 md:py-14">
        <div class="max-w-[1280px] mx-auto px-4 md:px-8">
            ...
            <h1 class="text-3xl md:text-5xl font-manrope font-extrabold text-charcoal mt-1 leading-tight">
                <?php echo esc_html($cat_name); ?> Tutorials &amp; Guides
            </h1>

            <?php if ($cat_desc): ?>
                <div class="font-inter text-textmuted text-base md:text-lg mt-4 max-w-3xl leading-relaxed">
                    <?php echo wp_kses_post($cat_desc); ?>
                </div>
            <?php else: ?>
                <p class="font-inter text-textmuted text-base md:text-lg mt-4 max-w-3xl leading-relaxed">
            ...
            <div class="mt-4 text-xs font-semibold text-textmuted">
        ...
        <div class="max-w-[1280px] mx-auto px-4 md:px-8">
                    ...
                    <?php while ($cat_query->have_posts()): $cat_query->the_post(); ?>
                        <article <?php post_class('bg-white rounded-2xl border border-bordercolor overflow-hidden flex flex-col justify-between relative transition-colors hover:border-bordercolor-hover group/card'); ?> itemscope itemtype="https://schema.org/BlogPosting" itemprop="mainEntity">
                            ...
                            <div>
                                ...
                                <div class="p-6">
                                    <h2 class="font-manrope font-bold text-xl text-charcoal leading-snug group-hover/card:text-teal transition-colors" itemprop="headline">
                    ...
                    <nav aria-label="Article pagination" class="mt-12 flex items-center justify-center gap-1.5 flex-wrap">
                        ...
                        ?>
                            <a href="<?php echo esc_url(get_pagenum_link($i)); ?>"
                               ...
                               class="inline-flex items-center justify-center min-w-[38px] h-[38px] px-3 rounded-lg text-sm font-manrope font-bold border transition-all <?php echo $i === $paged ? 'bg-teal text-white border-teal' : 'border-bordercolor text-charcoal hover:border-teal hover:text-teal'; ?>">
                                <?php echo (int) $i; ?>
                            </a>
            ...
            ?>
                <div class="text-center py-16">
                    <p class="text-textmuted font-inter text-base">No articles have been published in this category yet. Check back soon!</p>
